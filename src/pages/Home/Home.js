    ...
    <div className='page' id="home">
      ...
      <div className="gridContainer">
        ...
        <div className="gridItemB" >
          ...
          I am a software engineer with a strong background in frontend architecture, scalable web applications, and client-facing solutions. I design and build accessible, performant user experiences using modern HTML, CSS, and JavaScript frameworks, especially React. I have hands-on experience integrating AI and LLM technologies into web applications, enabling intelligent features and enhanced user interactions. I thrive in remote and distributed teams, and I adapt quickly to the tools and workflows required by the project. I hold dual nationality and am currently based in Central Europe, though I previously worked from SJO, Costa Rica. I am fluent in Français, Español, and English. When I am not coding, I explore short-film production, painting, and yoga. I also have experience with:<span><HomeHook /></span></p>
        </div>
